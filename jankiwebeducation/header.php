...
<head>
    <meta charset="utf-8">
    <title>Jankiweb Education</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="Jankiweb" name="keywords">
    <meta content="Jankiweb" name="description">
    ...
    <!-- Education Bootstrap Stylesheet -->
        ...
        <div class="row align-items-center py-4 px-xl-5">
            <div class="col-lg-3">
                <a href="" class="text-decoration-none">
                    <h1 class="m-0"><span class="text-primary">Janki</span>Web</h1>
                </a>
            </div>
